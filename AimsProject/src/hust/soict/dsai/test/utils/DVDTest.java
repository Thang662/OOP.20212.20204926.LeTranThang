...
public class DVDTest {
	...
	public static void main(String[] args) {
		DigitalVideoDisc dvd1 = new DigitalVideoDisc("AAAA", "aaaa", 5.6f);
		...
		Media[] sorted = MediaUtils.sortByCost(new DigitalVideoDisc[] {dvd1, dvd2, dvd3, dvd4, dvd5});
		System.out.println("Sort by cost: ");
		for (int i=0; i<sorted.length; i++) {
			System.out.println(sorted[i].toString());
		}
		
		sorted = MediaUtils.sortByTitle(new DigitalVideoDisc[] {dvd3, dvd5, dvd2, dvd4, dvd1});
